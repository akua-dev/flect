...
export const portableExtensionCapsule = async (options: PortableExtensionCapsuleOptions = {}) => {
	...
	const requiredCapabilities = options.requiredCapabilities ?? ['interface:read'];
	const optionalCapabilities = options.optionalCapabilities ?? ['interface:propose'];
				...
				extensions: [
					{
						...
						publicInstructions: 'Use only when asked for a bounded public project summary.',
						commands: [
							{
								id: 'summary',
								name: 'Summary',
