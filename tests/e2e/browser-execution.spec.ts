...
test('runs the pinned browser execution substrate in production Chromium', async ({ page }) => {
	...
	await expect(page.getByTestId('execution-vfs-isolation')).toHaveText('isolated');
