...
} from "./markdown-table-serialization";
...
const copyTable = Effect.fn("Flect.Markdown.copyTable")(function* (
  value: string,
) {
...
export function MarkdownTable({
  ...
  const acknowledgementTimer = useRef<
