...
export function ShareLibrary({
  ...
  useEffect(() => {
    ...
    const focus =
      active !== null && "focus" in active ? active.focus : undefined;
    openerRef.current =
  ...
  return (
    ...
    >
      ...
      <p className="share-library__intro">
        Each source keeps its own guarded Git fork. Removing it from this app
            ...
            return (
              <li className="share-library__item" key={entry.shareId}>
                ...
                <dl className="share-library__facts">
                  ...
                  <div>
                    <dt>Fork</dt>
                    <dd title={entry.refs.fork}>
                      {entry.refs.fork.slice(0, 10)}
                    </dd>
                  </div>
                </dl>
                ...
                {confirming ? (
                  <fieldset className="share-library__confirmation">
                    ...
                    {confirmation.action === "delete" && (
                      <code>
                        {entry.shareId} · flect/shared/…/fork ·{" "}
                        {entry.refs.fork}
                      </code>
                    )}
                    <div>
                  ...
                  <div className="share-library__actions">
                    <button
                      ...
                      disabled={busy}
                      onClick={() =>
                        void run(entry.shareId, () => onExport(entry.shareId))
                      }
                      type="button"
                    >
                      Export fork
