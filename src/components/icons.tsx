...
export function SearchIcon(props: IconProps) {
	return (
		<svg {...baseProps} height={16} viewBox='0 0 16 16' width={16} {...props}>
			...
			<path d='m10.25 10.25 3 3' stroke='currentColor' strokeLinecap='round' strokeWidth='1.4' />
		</svg>
	);
}

export function StarIcon({ filled = false, ...props }: IconProps & { readonly filled?: boolean }) {
	return (
		<svg
			{...baseProps}
