				...
				>
					...
					>
						...
						>
							...
							<small>
								{rollbackAvailable ? 'Restore the previous interface' : 'No previous revision'}
							</small>
						</button>
						...
						{(onOpenShareSource !== undefined ||
							...
							<fieldset className='composer-popover__group'>
								<legend className='composer-popover__section'>Share and review</legend>
								{onOpenShareSource !== undefined && (
									<button
									...
									>
										...
										<small>Open a shared file URL or exact public Git revision</small>
									</button>
								)}
								{onOpenShareFile !== undefined && (
									<button
