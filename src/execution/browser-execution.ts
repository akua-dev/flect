...
export interface BrowserExecutionShape {
	readonly probe: Effect.Effect<BrowserExecutionCapabilities, BrowserExecutionFailed>;
...
export class BrowserExecution extends Context.Service<BrowserExecution, BrowserExecutionShape>()(
