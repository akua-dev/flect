...
export const nativePlatformUnavailable = (reason: NativePlatformCapabilityFailure['reason']) =>
...
export interface NativePlatformShape {
	readonly systemAccentColor: Effect.Effect<NativeAccentColor, NativePlatformCapabilityFailure>;
	readonly startWindowDrag: Effect.Effect<void, NativePlatformCapabilityFailure>;
}

export class NativePlatform extends Context.Service<NativePlatform, NativePlatformShape>()(
