...
describe('Git share quarantine operations', () => {
	it.effect('strictly decodes bounded import and exact-commit inspection frames', () =>
		Effect.gen(function* () {
			...
			yield* Schema.decodeUnknownEffect(GitWorkspaceOperation, strict)(imported);
			yield* Schema.decodeUnknownEffect(GitWorkspaceOperation, strict)(inspect);
			...
			yield* Schema.decodeUnknownEffect(GitWorkspaceResult, strict)(importResult);
			yield* Schema.decodeUnknownEffect(GitWorkspaceResult, strict)(inspectResult);
			yield* Schema.decodeUnknownEffect(
				GitWorkspaceResult,
				strict
			)(
	...
	it.effect('rejects floating revisions and excess authority-bearing fields', () =>
		Effect.gen(function* () {
