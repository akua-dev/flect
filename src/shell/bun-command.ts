...
const route = (
  ...
  | { readonly call: BunOperationCall } => {
...
export const makeBunCommandService = (
  operations: BunOperationsShape,
): BunCommandShape => ({
...
export const makeBunCommandTestLayer = (
  execute: BunOperationsShape["execute"],
