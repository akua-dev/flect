...
import { makeLiveRoleSandboxedShellLayer, SandboxedShell } from './sandboxed-shell';
	...
	const live = makeLiveRoleSandboxedShellLayer({
		app: {
			files: {
				...
				'/workspace/src/index.ts': 'console.log("Flect app workspace is ready.");\n'
			}
		},
		previewApp: {
			files: {
				...
				'/workspace/src/index.ts': 'console.log("Flect candidate workspace is ready.");\n'
			}
		},
		shaper: {
			files: {
				...
				'/workspace/src/index.ts': 'console.log("Flect browser workspace is ready.");\n'
			}
		}
	}).pipe(
