...
export const makePiWorkbenchBridge = (
  emit: (event: InterfaceEditRequested) => void,
) => {
  const tool = defineTool({
    ...
    promptSnippet:
      "Request an explicit, visible handoff to Shaper for interface changes.",
    promptGuidelines: [
    ...
    parameters: Type.Object(
      {
        instruction: Type.String({
          ...
          maxLength: 4_000,
          description:
            "The user's concrete interface-change instruction for Shaper.",
        }),
      },
