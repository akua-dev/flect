...
import {
  ...
  ProductGraphql,
} from "../../src/capabilities/product-graphql";
...
export const referenceProductContext = ProductCapabilityRequestContext.make({
  ...
  requestDigest:
    "cd4432053439d08463cef5ade1450209bbd643bd654dfd668c28d62ce9a77b1e",
...
const manifests = [
  ...
  ProductCapabilityManifest.make({
    ...
    description:
      "Archive the single reference project through a fixed mutation.",
...
const listPolicy = ProductGraphqlPolicy.make({
  ...
  operationType: "query",
  documentSha256:
    "621a130bb2459d1afbdaa2517354d1bf65d314c742a4dd3faf0f1090814072b5",
...
const archivePolicy = ProductGraphqlPolicy.make({
  ...
  documentSha256:
    "98acdf51824f50006ffe13410e0e5ffcfc37968ccf87ee193442ccbdd8cab9fd",
  requestBytes: 16 * 1024,
  responseBytes: 64 * 1024,
  deadlineMs: 5_000,
});
...
export interface ReferenceProductOptions {
  ...
  readonly authorize?: (
    request: ReferenceProductAuthorizationRequest,
...
const decodeInput = <A>(
  ...
  Schema.decodeUnknownEffect(
    ...
    Effect.mapError(() =>
      productOperationFailure(operationId, "invalid-input"),
    ),
  );
