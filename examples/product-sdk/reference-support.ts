...
export const makeReferenceExperience = Effect.fn(
  "Flect.Examples.makeReferenceExperience",
...
export const decodeOperationInput = <A>(
  ...
  Schema.decodeUnknownEffect(
    ...
    Effect.mapError(() =>
      makeProductOperationFailure(operationId, "invalid-input"),
    ),
  );
  ...
  allowed.pipe(
    Effect.flatMap((accepted) =>
      accepted
        ...
        : Effect.fail(
            makeProductOperationFailure(operationId, "product-denied"),
          ),
    ),
  );
