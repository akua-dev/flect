...
export interface OfflineBoardOptions {
	...
	readonly authorize?: (request: OfflineBoardAuthorizationRequest) => Effect.Effect<boolean>;
}

export const makeOfflineBoardProduct = Effect.fn('Flect.Examples.makeOfflineBoardProduct')(
