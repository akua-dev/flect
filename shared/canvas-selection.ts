...
export class CanvasSelectionRect extends Schema.Class<CanvasSelectionRect>('CanvasSelectionRect')({
	x: Coordinate,
	y: Coordinate,
	width: Dimension,
	height: Dimension
...
export class CanvasSelection extends Schema.Class<CanvasSelection>('CanvasSelection')({
...
export const canvasSelectionSummary = (selection: CanvasSelection) =>
	[
		...
		...(selection.text === undefined ? [] : [`Visible text: ${selection.text}`]),
