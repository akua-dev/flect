...
const RepositoryPath = Schema.String.check(Schema.isMinLength(1), Schema.isMaxLength(512));
const GitArgument = Schema.String.check(Schema.isMinLength(1), Schema.isMaxLength(1_024));
const OutputText = Schema.String.check(Schema.isMaxLength(1_048_576));
const GitRemoteUrl = Schema.String.check(
	Schema.isMaxLength(2_048),
	Schema.isPattern(/^https:\/\/(?!(?:[^/]*@))[^\s]+$/)
);
export const GitObjectId = Schema.String.check(Schema.isPattern(/^[0-9a-f]{40}$/));
...
export class GitOpenRequest extends Schema.Class<GitOpenRequest>('GitOpenRequest')({
	type: Schema.Literal('open'),
	workspaceId: WorkspaceId,
	reset: Schema.Boolean
}) {}

export class GitWriteRequest extends Schema.Class<GitWriteRequest>('GitWriteRequest')({
	type: Schema.Literal('write'),
	path: RepositoryPath,
	contents: Schema.Uint8Array
}) {}

export class GitReadRequest extends Schema.Class<GitReadRequest>('GitReadRequest')({
...
export class GitRunRequest extends Schema.Class<GitRunRequest>('GitRunRequest')({
	...
	args: Schema.Array(GitArgument).check(Schema.isMinLength(1), Schema.isMaxLength(64))
}) {}

export class GitExportRequest extends Schema.Class<GitExportRequest>('GitExportRequest')({
	type: Schema.Literal('export')
}) {}

export class GitRemoveRequest extends Schema.Class<GitRemoveRequest>('GitRemoveRequest')({
...
export class GitCheckpointFile extends Schema.Class<GitCheckpointFile>('GitCheckpointFile')({
	path: RepositoryPath,
	contents: Schema.Uint8Array
}) {}
...
export class GitExportRefRequest extends Schema.Class<GitExportRefRequest>('GitExportRefRequest')({
	type: Schema.Literal('export-ref'),
	branch: GitBranchName.check(
		Schema.isPattern(/^flect\/shared\/[a-z0-9][a-z0-9/-]*\/(?:fork|candidate)$/)
	),
...
export class GitDeleteRefRequest extends Schema.Class<GitDeleteRefRequest>('GitDeleteRefRequest')({
	type: Schema.Literal('delete-ref'),
	branch: GitBranchName.check(Schema.isPattern(/^flect\/shared\/[a-z0-9][a-z0-9/-]*$/)),
	expectedCommit: GitObjectId,
	guards: Schema.Array(GitRefGuard).check(Schema.isMaxLength(8))
}) {}
...
export class GitMergeRefRequest extends Schema.Class<GitMergeRefRequest>('GitMergeRefRequest')({
	...
	conflictPaths: Schema.optionalKey(
		Schema.Array(RepositoryPath).check(Schema.isMinLength(1), Schema.isMaxLength(100))
	),
	guards: Schema.Array(GitRefGuard).check(Schema.isMaxLength(8)),
...
export class GitReadAtRefRequest extends Schema.Class<GitReadAtRefRequest>('GitReadAtRefRequest')({
	type: Schema.Literal('read-at-ref'),
	branch: GitBranchName,
	expectedCommit: GitObjectId,
	guards: Schema.Array(GitRefGuard).check(Schema.isMaxLength(8)),
	paths: Schema.Array(RepositoryPath).check(Schema.isMinLength(1), Schema.isMaxLength(64))
}) {}

export class GitMoveRefRequest extends Schema.Class<GitMoveRefRequest>('GitMoveRefRequest')({
...
export class GitStatusRequest extends Schema.Class<GitStatusRequest>('GitStatusRequest')({
...
export class GitWorkerRequest extends Schema.Class<GitWorkerRequest>('GitWorkerRequest')({
...
export class GitCommandResult extends Schema.Class<GitCommandResult>('GitCommandResult')({
...
export class GitExported extends Schema.Class<GitExported>('GitExported')({
	...
	fileCount: Schema.Int.check(Schema.isBetween({ minimum: 1, maximum: 20_000 }))
}) {}
...
export class GitCheckpointed extends Schema.Class<GitCheckpointed>('GitCheckpointed')({
...
export class GitShareInspected extends Schema.Class<GitShareInspected>('GitShareInspected')({
	type: Schema.Literal('share-inspected'),
	commit: GitObjectId,
	manifest: Schema.optionalKey(Schema.Uint8Array.check(Schema.isMaxLength(1_048_576))),
...
export class GitObjectsImported extends Schema.Class<GitObjectsImported>('GitObjectsImported')({
	type: Schema.Literal('objects-imported'),
	commit: GitObjectId,
	objectCount: Schema.Int.check(Schema.isBetween({ minimum: 1, maximum: 20_000 }))
}) {}
...
export class GitCommitInspected extends Schema.Class<GitCommitInspected>('GitCommitInspected')({
...
export class GitRefMergeConflict extends Schema.Class<GitRefMergeConflict>('GitRefMergeConflict')({
...
export class GitReadAtRef extends Schema.Class<GitReadAtRef>('GitReadAtRef')({
	...
	branch: GitBranchName,
	commit: GitObjectId,
	files: Schema.Array(GitRefFile).check(Schema.isMinLength(1), Schema.isMaxLength(64))
}) {}
...
export class GitRefSnapshot extends Schema.Class<GitRefSnapshot>('GitRefSnapshot')({
...
export class GitRepositoryStatus extends Schema.Class<GitRepositoryStatus>('GitRepositoryStatus')({
	type: Schema.Literal('status'),
...
export class GitWorkerSuccess extends Schema.Class<GitWorkerSuccess>('GitWorkerSuccess')({
	type: Schema.Literal('success'),
	id: RequestId,
	result: GitWorkspaceResult
}) {}

export class GitWorkerFailure extends Schema.Class<GitWorkerFailure>('GitWorkerFailure')({
	type: Schema.Literal('failure'),
	id: RequestId,
	error: GitWorkspaceFailureFrame
}) {}

export const GitWorkerResponse = Schema.Union([GitWorkerSuccess, GitWorkerFailure]);
...
export class GitTransactionDiagnosticResult extends Schema.Class<GitTransactionDiagnosticResult>(
	...
	snapshotValue: Schema.optionalKey(Schema.String.check(Schema.isMaxLength(1_024))),
	snapshotPaths: Schema.optionalKey(Schema.Array(RepositoryPath).check(Schema.isMaxLength(4_096))),
...
export class GitShareImportDiagnosticResult extends Schema.Class<GitShareImportDiagnosticResult>(
	...
	fileCount: Schema.Int.check(Schema.isBetween({ minimum: 1, maximum: 20_000 })),
	repositoryBytes: Schema.Int.check(Schema.isBetween({ minimum: 1, maximum: 32 * 1024 * 1024 })),
