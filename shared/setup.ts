...
export const AgentIntegrationHost = Schema.Literals([
  "codex",
  "claude",
  "opencode",
]);
...
export const AgentIntegrationState = Schema.Literals([
  "absent",
  "installed",
  "stale",
  "conflict",
...
export const ShellLinkState = Schema.Literals([
  "absent",
  "installed",
  "stale",
  "conflict",
...
export class ShellLinkStatus extends Schema.Class<ShellLinkStatus>(
  "ShellLinkStatus",
)({
...
export class ShellLinkError extends Schema.TaggedErrorClass<ShellLinkError>()(
  "ShellLinkError",
  {
