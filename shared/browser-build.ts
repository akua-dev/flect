...
export class BrowserBuildFile extends Schema.Class<BrowserBuildFile>('BrowserBuildFile')({
	path: BuildPath,
	contents: Schema.Uint8Array
}) {}

export class BrowserBuildRequest extends Schema.Class<BrowserBuildRequest>('BrowserBuildRequest')({
	version: Schema.Literal(1),
	buildId: BuildId,
	sourceRevision: SourceRevision,
	dependencyGraphDigest: Schema.optionalKey(Digest),
	entrypoint: BuildPath,
	files: Schema.Array(BrowserBuildFile).check(Schema.isMinLength(1), Schema.isMaxLength(2_048))
}) {}
...
export class BrowserBuildOutput extends Schema.Class<BrowserBuildOutput>('BrowserBuildOutput')({
	path: BuildPath,
...
export class BrowserBuildArtifact extends Schema.Class<BrowserBuildArtifact>(
	...
	outputs: Schema.Array(BrowserBuildOutput).check(Schema.isMinLength(1), Schema.isMaxLength(256))
}) {}
