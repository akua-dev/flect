...
export class ControlDescriptor extends Schema.Class<ControlDescriptor>('ControlDescriptor')({
...
export class ControlBrokerStatus extends Schema.Class<ControlBrokerStatus>('ControlBrokerStatus')({
	version: Schema.Literal(1),
...
export const ControlCommandOutcome = Schema.Union([ControlCommandSucceeded, ControlCommandFailed]);
...
export class ControlLogsResponse extends Schema.Class<ControlLogsResponse>('ControlLogsResponse')({
	version: Schema.Literal(1),
