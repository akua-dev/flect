...
export const UninstallOwnedKind = Schema.Literals(['shell-link', 'agent-integration']);
...
export class UninstallOwnedItem extends Schema.Class<UninstallOwnedItem>('UninstallOwnedItem')({
...
export class UninstallError extends Schema.TaggedErrorClass<UninstallError>()('UninstallError', {
