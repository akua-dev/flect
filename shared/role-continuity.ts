...
export class ContinuityDrafts extends Schema.Class<ContinuityDrafts>(
  "ContinuityDrafts",
)({
...
export class ContinuityMessage extends Schema.Class<ContinuityMessage>(
  "ContinuityMessage",
)({
...
const ContinuityMessages = Schema.Array(ContinuityMessage).check(
...
export class ContinuityRecovery extends Schema.Class<ContinuityRecovery>(
  "ContinuityRecovery",
)({
...
export type RoleContinuityCodecError =
  | InvalidRoleContinuity
  | RoleContinuityTooLarge;
...
export const emptyRoleContinuityRecord = (
...
export const decodeRoleContinuityRecord = Effect.fn(
  "Flect.RoleContinuity.decode",
)(function* (raw: string) {
...
export const encodeRoleContinuityRecord = Effect.fn(
  "Flect.RoleContinuity.encode",
)(function* (record: RoleContinuityRecord) {
